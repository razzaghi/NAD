...
namespace NAD\ResourceBundle\Manager;
...
class AbstractNodeManager
{
    ...
    {
        /**
         * @var $node \NAD\ResourceBundle\Entity\Category
         */
    ...
    public function getCategoryByURL($urlKey, $locale = null)
    {
        ...
        $pages = $this->em->getRepository('NADPageBundle:Page')->getPagesByCategory($category->getId());
