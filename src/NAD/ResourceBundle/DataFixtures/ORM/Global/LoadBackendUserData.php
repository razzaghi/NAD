...
{
    protected $fixturesName = array('global/nad_user_backend.xml');

    /**
     * Backend user manager
     * @return \NAD\BackendUserBundle\Manager\UserManager
     */
    protected function getUserManager()
    {
        return $this->container->get('administrator.user.manager');
    }
