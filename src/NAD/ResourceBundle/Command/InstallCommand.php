...
namespace NAD\ResourceBundle\Command;
...
class InstallCommand extends ContainerAwareCommand
{
    ...
    protected function configure()
    {
        $this
            ->setName('nad:install')
            ->setHelp(<<<EOT
The <info>nad:install</info> command launch installation process.
EOT
            );
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln('<info>********** Installing NAD **********</info>');
        $output->writeln('<info>**************************************</info>');
        $output->writeln('');
    ...
    protected function launchSetup(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($dialog->askConfirmation($output, '<question>Install site dependencies (Y/N)?</question>', false)) {
    ...
    protected function setupFiles(OutputInterface $output)
    {
        ...
        $frontendDir = realpath($this->getContainer()->get('kernel')->getRootDir() . '/../site/web');
        $backendDir = realpath($this->getContainer()->get('kernel')->getRootDir() . '/../administrator/web');
