...
namespace NAD\ResourceBundle\Tests;

use Symfony\Bundle\FrameworkBundle\Test\KernelTestCase;
use Symfony\Component\HttpKernel\KernelInterface;
use Doctrine\ORM\EntityManager;
use Symfony\Component\HttpKernel\Client;
use NAD\BackendUserBundle\Manager\UserManager;
...
abstract class AbstractWebTestCase extends KernelTestCase
{
    ...
    public static function setUpBeforeClass($httpHost = 'api.nad.dev')
    {
    ...
    public function setUp()
    {
        ...
        $this->um = static::$kernel->getContainer()->get('administrator.user.manager');
