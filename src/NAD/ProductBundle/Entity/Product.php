 ...
 * @ORM\Entity(repositoryClass="NAD\ProductBundle\Entity\ProductRepository")
 * @ORM\Table(name="nad_product")
 */
class Product
{
    /**
    ...
    /**
     * @var Collection
     * @ORM\OneToMany(targetEntity="NAD\ProductBundle\Entity\Image", mappedBy="product", cascade={"remove"})
     */
    private $images;
     ...
     * @var ArrayCollection
     *
     * @ORM\ManyToMany(targetEntity="NAD\ProductBundle\Entity\Category")
     * @ORM\JoinTable(
     *     name="nad_product_product_category",
     *     joinColumns={@ORM\JoinColumn(name="product_id", referencedColumnName="id")},
     *     inverseJoinColumns={@ORM\JoinColumn(name="category_id", referencedColumnName="id")}
     * )
     * @JMS\Expose
     * @JMS\MaxDepth(1)
     * @JMS\Type("ArrayCollection<NAD\ProductBundle\Entity\Category>")
     */
    private $categories;
