...
class OrderRepository extends AbstractCollectionRepository
{
    ...
    protected $model = 'NADOrderBundle:Order';
     ...
     *
     * @return \NAD\OrderBundle\Entity\Order $order|false
     */
     ...
     * @param mixed                                         $orderInfo
     *
     * @return \NAD\OrderBundle\Entity\Order $order
     */
